...
function Actividades() {
  ...
  const totalHoras = actividades.reduce(
    (total, actividad) => total + actividad.horas,
    0
  );

  const totalCupos = actividades.reduce(
    (total, actividad) => total + actividad.cupos,
    0
  );
    ...
    <Layout>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Explora todas las actividades organizadas por Bienestar
          Universitario y participa para acumular horas lúdicas.
        </p>
